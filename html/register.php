...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { // Manage form.
	...
	// Check for password and compare to confirmed password:
	...
	if ($fn && $ln && $e && $p) { // If everything is OK
		...
		if (mysqli_num_rows($r) == 0) { // Available.
			...
			if (mysqli_affected_rows($dbc) == 1) { // If it ran OK.
				...
				// Send the email:
				$body = "Thank you for registering at something.com. To activate your account, please click on this link:\n\n";
